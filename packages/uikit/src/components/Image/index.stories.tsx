...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://metaviralswap.com/images/tokens/${token.address[10434]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://metaviralswap.com/images/tokens/${token.address[10434]}.png`;
        const secondarySrc = `https://metaviralswap.com/images/tokens/${tokens[randomTokenIndex].address[10434]}.png`;
