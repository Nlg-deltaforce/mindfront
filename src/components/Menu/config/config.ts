...
import { DropdownMenuItems } from '@metaviralswap/uikit/src/components/DropdownMenu/types'
...
const config: (t: ContextApi['t'], languageCode?: string) => ConfigMenuItemsType[] = (t, 
  ...
  ) => [
  {
    ...
    items: [
      ...
      // {
      //   label: t('Perpetual'),
      //   href: `https://perp.metaviralswap.com/${perpLangMap(languageCode)}/futures/BTCUSDT`,
