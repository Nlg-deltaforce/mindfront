...
// import { ButtonMenu, ButtonMenuItem, LinkExternal, Flex, Svg, Image, Button } from '@metaviralswap/uikit'
    ...
    <Wrapper $isSide={isSide}>
      {/* <Flex flexDirection={isSide ? 'column' : ['column', 'column', 'row']} alignItems="center">
        <ButtonMenu variant="subtle" scale="sm" activeIndex={0}>
          ...
          <ButtonMenuItem as="a" href="https://v1exchange.metaviralswap.com/#/">
            {t('V1 (old)')}
          </ButtonMenuItem>
        </ButtonMenu>
        <LinkExternal
