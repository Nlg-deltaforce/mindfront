...
import { AutoRenewIcon, Box, Button, Flex, InjectedModalProps, Modal, Text, TwitterIcon } from '@metaviralswap/uikit'
  ...
  return (
    <Modal title={t('Congratulations!')} onDismiss={onDismiss}>
      <Flex flexDirection="column" alignItems="center" justifyContent="center">
        <Box>
          <NFTImage src="https://cdn.galaxy.eco/galaxy/assets/metaviralswap/1651655250130414893.png" />
        </Box>
        <Text textAlign="center" bold color="secondary" maxWidth="400px" fontSize="16px" mb="16px">
          {t('Hello, early fixed-term staking pool MTN lovers.')}
        </Text>
        <Text textAlign="center" maxWidth="400px" mb="12px">
          {t(
            'If you staked in our fixed-term staking pool for 52 weeks within the first 24 hours of the launch, you are eligible to claim a special edition “Project Galaxy x metaviralswap” NFT.',
          )}
        </Text>
        <Text textAlign="center" maxWidth="400px" mb="12px">
          {t(
        ...
        <Button
          ...
          scale="sm"
          as="a"
          href="https://twitter.com/metaviralswap/status/1521825079591845888"
