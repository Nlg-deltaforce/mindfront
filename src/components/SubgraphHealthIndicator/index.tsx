...
import { Card, Flex, Box, InfoIcon, Text, useTooltip } from '@metaviralswap/uikit'
...
const FixedSubgraphHealthIndicator = () => {
  ...
  return isOnNftPages ? <SubgraphHealthIndicator subgraphName="metaviralswap/nft-market" /> : null
}
