...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master MTN chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of MTN.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's MTN)`,
...
describe('Check translations available', () => {
  ...
  throughDirectory('node_modules/@metaviralswap/uikit', true)
