import { Button, Flex, Link, LinkExternal, MetamaskIcon, Skeleton, Text, TimerIcon } from '@metaviralswap/uikit'
...
const PoolStatsInfo: React.FC<ExpandedFooterProps> = ({
  ...
  return (
    <>
      {profileRequirement && (profileRequirement.required || profileRequirement.thresholdPoints.gt(0)) && (
        <Flex mb="8px" justifyContent="space-between">
          ...
          <Text small textAlign="right">
            {profileRequirement.required && t('MetaViral Profile')}{' '}
      ...
      {vaultKey && (
        <Flex mb="2px" justifyContent={alignLinksToRight ? 'flex-end' : 'flex-start'}>
          <LinkExternal href="https://metaviralswap.com/" bold={false} small>
            {t('View Project Site')}
          </LinkExternal>
        </Flex>
      )}
          ...
          <Button
            ...
            onClick={() =>
              registerToken(
                ...
                `https://tokens.metaviralswap.com/images/${tokenAddress}.png`,
              )
            }
          >
