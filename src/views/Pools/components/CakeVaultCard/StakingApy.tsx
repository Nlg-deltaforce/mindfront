import { Flex, Text, Skeleton, useModal, Button, CalculateIcon } from '@metaviralswap/uikit'
  ...
  return (
    <LightGreyCard>
      <Flex alignItems="center" justifyContent="space-between">
        <Text color="#141414" textTransform="uppercase" bold fontSize="12px">
          {t('Flexible')} APY:
        </Text>
        {flexibleApy ? (
          <AprLabelContainer alignItems="center" justifyContent="flex-start">
            ...
            <Button
              ...
              marginLeft="4px"
            >
              <CalculateIcon color="#141414" width="20px" />
            </Button>
          </AprLabelContainer>
        ) : (
