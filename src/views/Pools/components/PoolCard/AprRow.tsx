import { Flex, TooltipText, useTooltip } from '@metaviralswap/uikit'
...
const AprRow: React.FC<AprRowProps> = ({ pool, stakedBalance, performanceFee = 0, showIcon = true }) => {
  ...
  const tooltipContent = vaultKey
    ? t('APY includes compounding, APR doesn’t. This pool’s MTN is compounded automatically, so we show APY.')
