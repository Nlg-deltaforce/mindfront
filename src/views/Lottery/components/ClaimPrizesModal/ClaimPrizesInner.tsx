...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from '@metaviralswap/uikit'
    ...
    if (receipt?.status) {
      toastSuccess(
        ...
        <ToastDescriptionWithTx txHash={receipt.transactionHash}>
          {t('Your MTN prizes for round %lotteryId% have been sent to your wallet', { lotteryId })}
