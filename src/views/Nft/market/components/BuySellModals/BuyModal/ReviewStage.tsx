...
import { Flex, Text, Button, ButtonMenu, ButtonMenuItem, Message, Link } from '@metaviralswap/uikit'
  ...
  return (
    <>
      <Flex px="24px" pt="24px" flexDirection="column">
        ...
        <BorderedBox>
          ...
          <ButtonMenu
            ...
            variant="subtle"
          >
            <ButtonMenuItem>MTV</ButtonMenuItem>
            <ButtonMenuItem>WMTV</ButtonMenuItem>
          </ButtonMenu>
          <Text small color="textSubtle">
            {t('Total payment')}
          </Text>
          ...
          <Text small color="textSubtle">
            {t('%symbol% in wallet', { symbol: paymentCurrency === PaymentCurrency.MTV ? 'MTV' : 'WMTV' })}
          </Text>
          {!account ? (
          ...
          <Message p="8px" variant="danger">
            <Text>
              {t('Not enough %symbol% to purchase this NFT', {
                symbol: paymentCurrency === PaymentCurrency.MTV ? 'MTV' : 'WMTV',
              })}
            </Text>
          </Message>
        )}
        <Flex alignItems="center">
          <Text my="16px" mr="4px">
            {t('Convert between MTV and WMTV for free')}:
          </Text>
          <Button
            as={Link}
            p="0px"
            ...
            external
            variant="text"
            href="/swap?inputCurrency=MTV&outputCurrency=0x3026EDD7D037Fef2d1Dd25ef4Ff2E87c0244a041"
          >
            {t('Convert')}
          </Button>
        </Flex>
      ...
      <Flex px="24px" pb="24px" flexDirection="column">
        ...
        <Button as={Link} external style={{ width: '100%' }} href="/swap?outputCurrency=MTV" variant="secondary">
          {t('Get %symbol1% or %symbol2%', { symbol1: 'MTV', symbol2: 'WMTV' })}
        </Button>
      </Flex>
    </>
  )
