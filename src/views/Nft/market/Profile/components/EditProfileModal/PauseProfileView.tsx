...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@metaviralswap/uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss, onSuccess }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t('Cost to reactivate in the future: %cost% MTN', { cost: formatBigNumber(numberCakeToReactivate) })}
      </Text>
