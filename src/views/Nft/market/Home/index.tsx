...
import { Box, Button, Flex, Heading, LinkExternal } from '@metaviralswap/uikit'
  ...
  return (
    <>
        ...
        <StyledHeaderInner>
          <div>
            ...
            <Heading scale="lg" color="text">
              {t('Buy and Sell NFTs on MTV Smart Chain')}
            </Heading>
            {account && (
      ...
      <Gradient p="64px 0">
        ...
        <LinkExternal href="https://docs.metaviralswap.com/contact-us/nft-market-applications" mx="auto" mt="16px">
