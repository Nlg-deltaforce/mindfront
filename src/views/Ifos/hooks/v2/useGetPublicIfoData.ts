...
// https://github.com/metaviralswap/pancake-contracts/blob/master/projects/ifo/contracts/IFOV2.sol#L431
// 1,000,000,000 / 100
...
const useGetPublicIfoData = (ifo: Ifo): PublicIfoData => {
  ...
  const currencyPriceInUSD = ifo.currency === tokens.mtn ? cakePriceUsd : lpTokenPriceInUsd
