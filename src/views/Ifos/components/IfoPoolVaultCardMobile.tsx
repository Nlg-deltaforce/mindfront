import { Box, Card, CardBody, CardHeader, ExpandableButton, Flex, Text, Message, Button } from '@metaviralswap/uikit'
      ...
      <CardHeader p="16px">
        ...
        <Flex justifyContent="space-between" alignItems="center">
          <StyledTokenContent alignItems="center" flex={1}>
            <TokenPairImage width={24} height={24} primaryToken={tokens.mtn} secondaryToken={tokens.mtn} />
            <Box ml="8px">
              <Text small bold>
                {t('IFO MTN')}
              </Text>
          ...
          <StyledCardBody>
            <Message variant="warning" mb="20px">
              <Flex flexDirection="column">
                <Text mb="16px">
                  {t(
                    'This is the old IFO MTN pool. Check out the brand new MTN pool to learn how to earn MTN rewards with higher APY while enjoying other benefits.',
                  )}
                </Text>
                <Flex ml="-34px">
                  <Button onClick={handleOnClick} width="100%">
                    {isShowMigrationButton ? t('Migrate') : t('Go to new MTN pool')}
                  </Button>
                </Flex>
              </Flex>
            </Message>
            <ActionContainer>
              ...
              <Box mt="24px">
                <Flex alignItems="center" justifyContent="space-between">
                  <Text fontSize="14px">{`${t('Recent MTN profit')}:`}</Text>
                  <Balance
                    bold
                    fontSize="14px"
