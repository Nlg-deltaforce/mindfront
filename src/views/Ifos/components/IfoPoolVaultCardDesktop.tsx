import { Box, Card, CardBody, CardHeader, Flex, Text, Message, Button } from '@metaviralswap/uikit'
        ...
        <StyledTokenContent justifyContent="space-between" alignItems="center">
          <Box ml="8px">
            ...
            <Text color="textSubtle" fontSize="14px">
              {t('Stake MTN to participate in IFO')}
            </Text>
          </Box>
          <TokenPairImage width={64} height={64} primaryToken={tokens.mtn} secondaryToken={tokens.mtn} />
        </StyledTokenContent>
      </CardHeader>
      <StyledCardBody>
