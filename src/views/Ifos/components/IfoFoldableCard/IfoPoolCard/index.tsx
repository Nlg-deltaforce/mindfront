...
import { Box, Card, CardBody, CardHeader, Flex, HelpIcon, Text, useTooltip } from '@metaviralswap/uikit'
...
export const cardConfig = (
  ...
  switch (poolId) {
    case PoolIds.poolBasic:
      if (meta?.version === 3.1) {
        const MSG_MAP = {
          needQualifiedNFT: t('Set PancakeSquad NFT as MetaViral Profile avatar.'),
          needQualifiedPoints: t('Reach a certain MetaViral Profile Points threshold.'),
        }
