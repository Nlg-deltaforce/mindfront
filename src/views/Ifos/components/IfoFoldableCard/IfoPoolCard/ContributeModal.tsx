...
const ContributeModal: React.FC<Props> = ({
  ...
  const label = currency === tokens.mtn ? t('Max. MTN entry') : t('Max. token entry')
  ...
  // in v3 max token entry is based on ifo mtv and hard cap limit per user minus amount already committed
      ...
      <ModalBody maxWidth="360px">
        ...
        <Box p="2px">
          ...
          <Text color="textSubtle" fontSize="12px" mb="24px">
            {t(
              'If you don’t commit enough MTN, you may not receive any IFO tokens at all and will only receive a full refund of your MTN.',
            )}
            <Link
              fontSize="12px"
              display="inline"
              href="https://docs.metaviralswap.com/products/ifo-initial-farm-offering"
              external
            >
              {t('Read more')}
            </Link>
