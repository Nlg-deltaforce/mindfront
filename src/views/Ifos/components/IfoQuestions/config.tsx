...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        MTN up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active MetaViral profile can commit. However the maximum amount of MTN
        user can commit, is equal to the average MTN balance in the IFO MTN pool prior to the IFO. And there’s a fee
  ...
  },
  {
    ...
    description: [<Trans>The MTN from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of MTN to either sale.</Trans>,
      <Trans>
