...
import { Button, Heading, Text, Flex, Link, Breadcrumbs } from '@metaviralswap/uikit'
        ...
        <Flex flexDirection={['column-reverse', null, 'row']}>
          <Left>
            ...
            <Text color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid MTN for the right to host a 7-day Farm on MetaViral.')}
            </Text>
