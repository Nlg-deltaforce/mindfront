import { Heading, Button, Text } from '@metaviralswap/uikit'
  ...
  return (
    <>
      ...
      <Text color="textSubtle">
        {t('It looks like you’ve disabled your account by removing your MetaViral Collectible (NFT) profile picture.')}
      </Text>
      <Text>
