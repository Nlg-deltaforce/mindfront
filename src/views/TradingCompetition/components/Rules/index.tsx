import { Flex, Text } from '@metaviralswap/uikit'
      ...
      <StyledCardWrapper>
        <RulesCard title={t('Trade to increase your rank')}>
          <Text textAlign="center" fontSize="14px" color="textSubtle">
            {t(
              'Eligible pairs: DAR/MTV, MTN/MTV, and MTN/MUSD. Please note that the volume from limit orders will not be indexed.',
            )}
          </Text>
        </RulesCard>
