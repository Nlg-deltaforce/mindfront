...
import { Heading, Text, Button, ArrowForwardIcon, Link } from '@metaviralswap/uikit'
  ...
  const steps: Step[] = [
    {
      ...
      canHover: true,
      text: t('Unstake LP tokens and MTN from the old MasterChef contract.'),
    },
    {
      stepId: ProgressStepsType.STEP2,
      canHover: true,
      text: t('Stake LP tokens and MTN to the new MasterChef v2 contract.'),
    },
  ]
  ...
  return (
    <div ref={tableWrapperEl}>
      <PageHeader>
        ...
        <Link href="https://docs.metaviralswap.com/code/migration/migrate-your-stakings" external>
