import { Button, Flex, Box, Modal, Text, ChevronRightIcon, InjectedModalProps, Tag, Spinner } from '@metaviralswap/uikit'
...
export const DetailLimitOrderModal: React.FC<DetailLimitOrderModalProps> = ({ onDismiss, order, formattedOrder }) => {
  ...
  const orderDetails = (
    <>
      ...
      <LimitTradeInfoCard
        currentPriceExchangeRateText="0.002474 MTV = 1 MUSD"
        currentPriceExchangeRateTextReversed="404.11169 MUSD = 1 MTV"
