...
const eventDescriptionConfigBuilder = ({ t }: EventDescriptionType) => ({
  ...
  subHeadingText: t(
    'All MetaViral Squad NFTs are allocated to Squad Ticket holders through a provably-fair system based on ChainLink at the time of minting.',
  ),
  ...
  bodyText: [
    {
      id: 1,
      content: (
        <>{t('490 are available in the pre-sale for owners of Gen 0 MetaViral Bunnies (bunnyID 0, 1, 2, 3, 4)')}</>
      ),
    },
