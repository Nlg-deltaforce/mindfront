import { Text } from '@metaviralswap/uikit'
...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the MetaViral Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 MetaViral Bunny NFTs at the snapshot may also purchase one additional MetaViral Squad NFT in the presale for each MetaViral Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of MTN spent on MetaViral Squad NFTs will be burned as part of our weekly MTN burn.')],
  },
  {
