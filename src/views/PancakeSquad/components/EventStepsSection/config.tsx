  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active MetaViral Profile to buy Minting Tickets and mint a MetaViral Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold DBCC'),
      bodyText: [t('Each NFT costs DBCC to mint. Remember you also need MTV to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://metaviralswap.com/swap"
            target="_blank"
            width="100%"
          >
            {t('Buy DBCC')}
    ...
    },
    {
      ...
      bodyText: [
        ...
        `04:00 UTC, Oct. 7 ${t(
          'Pre-sale: Wallets which held “Gen 0” MetaViral Bunnies NFTs (bunnyID 0,1,2,3,4) at a snapshot taken some time between 12 and 2 hours before the presale begins can purchase one Squad Ticket per Gen 0 NFT.',
        )}`,
        `08:00 UTC, Oct. 7 ${t(
          'Public Sale: Any wallet with an active MetaViral Profile can purchase up to 10 Squad Tickets, while stocks last.',
        )}`,
      ],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Claim Phase'),
      bodyText: [
        t('During this phase, any wallet holding a Squad Ticket can redeem their ticket to claim a MetaViral Squad NFT.'),
      ],
      buttons: (
        <>
          {hasData && (
