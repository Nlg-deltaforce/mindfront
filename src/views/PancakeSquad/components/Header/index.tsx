...
import { Box, Flex, lightColors, Spinner, Text, Timeline } from '@metaviralswap/uikit'
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('MetaViral’s first official generative NFT collection.')}
      </Text>
