...
import { ArrowForwardIcon, Button, Flex, Heading, Skeleton, Text } from '@metaviralswap/uikit'
...
const PredictionCardContent = () => {
  ...
  const bnbWonText = t('$%bnbWonInUsd% in MTV won so far', { bnbWonInUsd: '#placeholder#' })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="#280D5F" mb="40px">
          {t('Will MTV price rise or fall? guess correctly to win!')}
        </Text>
      </Flex>
