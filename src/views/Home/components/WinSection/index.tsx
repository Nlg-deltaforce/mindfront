...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@metaviralswap/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'MTN card' },
    { src: 'green', alt: 'Green MTN card with up arrow' },
    { src: 'red', alt: 'Red Mtn card with down arrow' },
    { src: 'top-right', alt: 'MTN card' },
  ],
}
