...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@metaviralswap/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in MTN prizes this round', { cakePrizeInUsd: cakePriceBusd.toString() })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with MTN, win MTN if your numbers match')}
        </Text>
      </Flex>
