import { ArrowForwardIcon, Button, Text, Link, useMatchBreakpointsContext } from '@metaviralswap/uikit'
...
const PerpetualBanner = () => {
  ...
  const perpetualUrl = useMemo(() => `https://perp.metaviralswap.com/${perpLangMap(code)}/futures/BTCUSDT`, [code])
