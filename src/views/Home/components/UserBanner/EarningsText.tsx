...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and MTN pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and MTN pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from MTN pool', data)
  }
