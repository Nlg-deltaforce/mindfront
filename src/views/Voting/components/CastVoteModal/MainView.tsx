import { IconButton, Text, Skeleton, Button, AutoRenewIcon, ChevronRightIcon, Message } from '@metaviralswap/uikit'
          ...
          <>
            ...
            {total === 0 ? (
              <Message variant="danger" mb="12px">
                <Text color="danger">
                  {t(
                    'Hold some MTN in your wallet or on MetaViral at the snapshot block to get voting power for future proposals.',
                  )}
                </Text>
              </Message>
            ) : (
