...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@danielvindax/metaviral-sdk'
import { Button, Text, AddIcon, CardBody, Message, useModal, TooltipText, useTooltip } from '@metaviralswap/uikit'
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB_: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        router.replace(`/add/${currencyIdA || 'MTV'}/${newCurrencyIdB}`, undefined, { shallow: true })
      }
    },
