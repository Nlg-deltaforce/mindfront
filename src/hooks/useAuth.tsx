...
import { ConnectorNames, connectorLocalStorageKey, Text, Box, LinkExternal } from '@metaviralswap/uikit'
            ...
            if (error instanceof NoEthereumProviderError || error instanceof NoBscProviderError) {
              toastError(
                ...
                <Box>
                  ...
                  <LinkExternal href="https://docs.metaviralswap.com/get-started/connection-guide">
                    {t('Need help ?')}
                  </LinkExternal>
                </Box>,
              )
