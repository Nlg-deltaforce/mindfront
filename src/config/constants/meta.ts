...
export const DEFAULT_META: PageMeta = {
  title: 'MetaViral',
  description:
    'The most popular AMM on BSC by user count! Earn MTN through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by MetaViral), NFTs, and more, on a platform you can trust.',
  image: 'https://metaviralswap.com/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for MetaViral exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for MetaViral exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for MetaViral exchanges.' },
      ...
      '/pancake-squad': { basePath: true, title: t('MetaViral Squad') },
    },
