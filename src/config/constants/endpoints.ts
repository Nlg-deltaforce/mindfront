...
export const INFO_CLIENT = 'https://thegraph.metaviralswap.com/subgraphs/name/metaviralswap/exchange'
export const BLOCKS_CLIENT = 'https://thegraph.metaviralswap.com/subgraphs/name/metaviralswap/blocks'
export const GRAPH_API_NFTMARKET = process.env.NEXT_PUBLIC_GRAPH_API_NFT_MARKET
export const GRAPH_HEALTH = 'https://thegraph.metaviralswap.com/index-node/graphql'
