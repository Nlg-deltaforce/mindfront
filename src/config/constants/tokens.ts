import { ChainId, Token } from '@danielvindax/metaviral-sdk'
...
export const mainnetTokens = defineTokens({
  wmtv: new Token(
    MAINNET,
    '0x3026EDD7D037Fef2d1Dd25ef4Ff2E87c0244a041',
    18,
    'WMTV',
    'Wrapped MTV',
    'https://metaviralscan.com/',
  ),
  // bnb here points to the wbnb contract. Wherever the currency BNB is required, conditional checks for the symbol 'BNB' can be used
  mtv: new Token(MAINNET, '0x3026EDD7D037Fef2d1Dd25ef4Ff2E87c0244a041', 18, 'MTV', 'MTV', 'https://metaviralscan.com/'),
  mtn: new Token(MAINNET, '0xd30854a284C72Ef4969B74b64628DB4bD697e900', 18, 'MTN', 'MTN', 'https://metaviralscan.com/'),
  ...
  usdt: new Token(
    MAINNET,
    '0xE67002E8d2954240CE6ee6b1C148aDb3836489Ae',
    18,
    'USDT',
    'Tether USD',
    'https://tether.to/',
  ...
  musd: new Token(
    MAINNET,
    '0x3aA7D6a99aB3Bf6CC5c6111fFc0d6a2b062bD067',
    18,
    'MUSD',
    'Mtv USD',
    '',
...
export const testnetTokens = defineTokens({
  ...
  mtn: new Token(
    ...
    18,
    'MTN',
    'MetaViralManna Token',
    'https://metaviralswap.com/',
  ),
  musd: new Token(
    TESTNET,
