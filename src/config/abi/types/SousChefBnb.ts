...
export interface SousChefBnbInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "WMTV", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "WMTV", data: BytesLike): Result;
...
export interface SousChefBnb extends BaseContract {
  ...
  functions: {
    WMTV(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    WMTV(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    WMTV(overrides?: CallOverrides): Promise<PopulatedTransaction>;
