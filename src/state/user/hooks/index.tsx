import { ChainId, Pair, Token } from '@danielvindax/metaviral-sdk'
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'MTN-LP', 'MetaViral LPs')
}
...
export function useTrackedTokenPairs(): [Token, Token][] {
  ...
  const combinedList = useMemo(
    () => {
      console.log(userPairs, generatedPairs, pinnedPairs, farmPairs)
