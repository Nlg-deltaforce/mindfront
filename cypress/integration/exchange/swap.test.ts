describe('Swap', () => {
  ...
  it('should get input and output currency from url params', () => {
    cy.visit('/swap?inputCurrency=0xb30ebc0Ec978472B4a500a717880fE4D8f8c3288&outputCurrency=MTV')
    cy.get('#swap-currency-input #pair').should('contain', 'MUSD')
    cy.get('#swap-currency-output #pair').should('contain', 'MTV')
  })
